...
public enum Template {
    ...
    T31 (1, 0, "Szablon PWD T3.1", "szablon-pwd-t3-1", "szablon_pwd_3_1", 1, 1, 0, "Szablon dla Urzędu Miasta lub Gminy w wersji podstawowej (z elementami BIP)"),
    T32 (0, 0, "Szablon PWD T3.2", "szablon-pwd-t3-2", "szablon_pwd_3_2", 1, 1, 0, "Szablon dla Urzędu Miasta lub Gminy w wersji okolicznościowej (z elementami BIP)"),
    T33 (0, 1, "Szablon PWD T3.3", "szablon-pwd-t3-3", "szablon_pwd_3_3", 1, 1, 0, "Szablon dla Urzędu Miasta lub Gminy w wersji alternatywnej (z elementami BIP)"),
