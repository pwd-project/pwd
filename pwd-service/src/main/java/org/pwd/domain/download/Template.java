...
public enum Template {
    ...
    T31 (1, 0, "Szablon PWD T3.1", "szablon-pwd-t3-1", "szablon_pwd_3_1", 0, 0, 0, "Szablon dla Urzędu Miasta lub Gminy w wersji podstawowej (z elementami BIP)"),
    T32 (0, 0, "Szablon PWD T3.2", "szablon-pwd-t3-2", "szablon_pwd_3_2", 0, 0, 0, "Szablon dla Urzędu Miasta lub Gminy w wersji okolicznościowej (z elementami BIP)"),
    T33 (0, 1, "Szablon PWD T3.3", "szablon-pwd-t3-3", "szablon_pwd_3_3", 0, 0, 0, "Szablon dla Urzędu Miasta lub Gminy w wersji alternatywnej (z elementami BIP)"),
    ...
    T61 (1, 0, "Szablon PWD T6.1", "szablon-pwd-t6-1", "szablon_pwd_6_1", 0, 0, 0, "Szablon dla Stowarzyszenia lub Fundacji w wersji podstawowej"),
    T62 (0, 0, "Szablon PWD T6.2", "szablon-pwd-t6-2", "szablon_pwd_6_2", 0, 0, 0, "Szablon dla Stowarzyszenia lub Fundacji w wersji alternatywnej"),
    T63 (0, 1, "Szablon PWD T6.3", "szablon-pwd-t6-3", "szablon_pwd_6_3", 0, 0, 0, "Szablon dla Stowarzyszenia lub Fundacji w wersji alternatywnej")
    ;
