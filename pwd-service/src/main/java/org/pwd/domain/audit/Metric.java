...
public enum Metric {
    ...
    formattingTags(
            1, "Gęstość tagów formatujących", "1.3.1", "http://fdc.org.pl/wcag2/#content-structure-separation"),
    ...
    anyTitle(
            1, "Tytuł strony", "2.4.2", "http://fdc.org.pl/wcag2/#navigation-mechanisms"),
    headerContent(
            3, "Nagłówki sekcji", "2.4.10", "http://fdc.org.pl/wcag2/#navigation-mechanisms"),
    htmlLang(
    ...
    requiredAriaAttributeMissing(
            1, "Wymagane atrybuty dla elementów z rolami ARIA", "AX_ARIA_03", "https://github.com/GoogleChrome/accessibility-developer-tools/wiki/Audit-Rules#ax_aria_03"),
    badAriaAttributeValue(
            1, "Stan i poprawność właściwości elementów ARIA", "AX_ARIA_04", "https://github.com/GoogleChrome/accessibility-developer-tools/wiki/Audit-Rules#ax_aria_04"),
    ...
    requiredOwnedAriaRoleMissing(
            1, "Właściwe role elementów podrzędnych", "AX_ARIA_08", "https://github.com/GoogleChrome/accessibility-developer-tools/wiki/Audit-Rules#ax_aria_08"),
    ariaRoleNotScoped(
            1, "Właściwy zakres elementów ARIA", "AX_ARIA_09", "https://github.com/GoogleChrome/accessibility-developer-tools/wiki/Audit-Rules#ax_aria_09"),
    unsupportedAriaAttribute(
            1, "Obsługiwane atrybuty ARIA", "AX_ARIA_10", "https://github.com/GoogleChrome/accessibility-developer-tools/wiki/Audit-Rules#ax_aria_10"),
    badAriaAttribute(
    ...
    duplicateId(
            1, "Unikalność identyfikatorów elementów", "AX_HTML_02", "https://github.com/GoogleChrome/accessibility-developer-tools/wiki/Audit-Rules#ax_html_02"),
    multipleLabelableElementsPerLabel(
            1, "Etykietowanie elementów", "AX_TEXT_03", "https://github.com/GoogleChrome/accessibility-developer-tools/wiki/Audit-Rules#ax_text_03"),
