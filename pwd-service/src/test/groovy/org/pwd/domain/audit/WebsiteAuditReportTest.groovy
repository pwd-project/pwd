...
class WebsiteAuditReportTest extends Specification {
    ...
    def "should calc score as weighted average"() {
        ...
        new WebsiteAuditReport(200, [anyTitle.create(20), alt.create(55)]).score() == 37.5
        new WebsiteAuditReport(200, [anyTitle.create(20), alt.create(50), htmlLang.create(20)]).score() == 30
